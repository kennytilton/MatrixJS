...
var args10592 = [];
var len__8226__auto___10596 = arguments.length;
var i__8227__auto___10597 = (0);
while(true){
if((i__8227__auto___10597 < len__8226__auto___10596)){
args10592.push((arguments[i__8227__auto___10597]));

var G__10598 = (i__8227__auto___10597 + (1));
i__8227__auto___10597 = G__10598;
continue;
} else {
}
break;
...
var G__10595 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10595,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10595;
}
});
...
var or__7113__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__8226__auto___10603 = arguments.length;
var i__8227__auto___10604 = (0);
while(true){
if((i__8227__auto___10604 < len__8226__auto___10603)){
args__8233__auto__.push((arguments[i__8227__auto___10604]));

var G__10605 = (i__8227__auto___10604 + (1));
i__8227__auto___10604 = G__10605;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8234__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10600){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__10601,G__10602,seq10600__$2);
});
...
var file = cljs.core.get.call(null,map__10609__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10609__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10609__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10609,map__10609__$1,file,line,column){
return (function (p1__10606_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10606_SHARP_));
});})(map__10609,map__10609__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__8046__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__8046__auto__,prefer_table__8047__auto__,method_cache__8048__auto__,cached_hierarchy__8049__auto__,hierarchy__8050__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__7113__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__7113__auto__)){
return or__7113__auto__;
} else {
...
var temp__4657__auto___10611 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___10611)){
var message_10612 = temp__4657__auto___10611;
cljs.core.println.call(null,message_10612);
} else {
}
...
var temp__4657__auto___10613 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___10613)){
var message_10614 = temp__4657__auto___10613;
cljs.core.println.call(null,message_10614);
} else {
}
...
var temp__4655__auto__ = (function (){var and__7101__auto__ = typeof exception.stack === 'string';
if(and__7101__auto__){
var G__10624 = exception.stack;
var G__10624__$1 = (((G__10624 == null))?null:clojure.string.split_lines.call(null,G__10624));
var G__10624__$2 = (((G__10624__$1 == null))?null:cljs.core.get.call(null,G__10624__$1,depth));
if((G__10624__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10624__$2);
}
} else {
...
var vec__10625 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10625,(0),null);
var column = cljs.core.nth.call(null,vec__10625,(1),null);
var vec__10628 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10628,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10628,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10628,(2),null);
...
var m__$1 = (function (){var G__10632 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__10632) {
case "fail":
...
var G__10638 = (function (){var G__10637 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10637);
} else {
return G__10637;
}
})();
...
return cljs.core.vary_meta.call(null,G__10640,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__10644 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__10644) {
...
var vec__10649 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10649,(0),null);
var types = vec__10649;
...
return cljs.core.map.call(null,(function (p__10661){
var vec__10662 = p__10661;
var ns = cljs.core.nth.call(null,vec__10662,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10662,(1),null);
return ((function (vec__10662,ns,vars__$1){
return (function (){
...
var G__10665 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__10665) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1){
return (function (){
var seq__10666 = cljs.core.seq.call(null,vars__$1);
var chunk__10667 = null;
var count__10668 = (0);
var i__10669 = (0);
while(true){
if((i__10669 < count__10668)){
var v = cljs.core._nth.call(null,chunk__10667,i__10669);
var temp__4657__auto___10671 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___10671)){
var t_10672 = temp__4657__auto___10671;
each_fixture_fn.call(null,((function (seq__10666,chunk__10667,count__10668,i__10669,t_10672,temp__4657__auto___10671,v,each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10672)));
});})(seq__10666,chunk__10667,count__10668,i__10669,t_10672,temp__4657__auto___10671,v,each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1))
);
} else {
}

var G__10673 = seq__10666;
var G__10674 = chunk__10667;
var G__10675 = count__10668;
var G__10676 = (i__10669 + (1));
seq__10666 = G__10673;
chunk__10667 = G__10674;
count__10668 = G__10675;
i__10669 = G__10676;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__10666);
if(temp__4657__auto__){
var seq__10666__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10666__$1)){
var c__7932__auto__ = cljs.core.chunk_first.call(null,seq__10666__$1);
var G__10677 = cljs.core.chunk_rest.call(null,seq__10666__$1);
var G__10678 = c__7932__auto__;
var G__10679 = cljs.core.count.call(null,c__7932__auto__);
var G__10680 = (0);
seq__10666 = G__10677;
chunk__10667 = G__10678;
count__10668 = G__10679;
i__10669 = G__10680;
continue;
} else {
var v = cljs.core.first.call(null,seq__10666__$1);
var temp__4657__auto___10681__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___10681__$1)){
var t_10682 = temp__4657__auto___10681__$1;
each_fixture_fn.call(null,((function (seq__10666,chunk__10667,count__10668,i__10669,t_10682,temp__4657__auto___10681__$1,v,seq__10666__$1,temp__4657__auto__,each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10682)));
});})(seq__10666,chunk__10667,count__10668,i__10669,t_10682,temp__4657__auto___10681__$1,v,seq__10666__$1,temp__4657__auto__,each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1))
);
} else {
}

var G__10683 = cljs.core.next.call(null,seq__10666__$1);
var G__10684 = null;
var G__10685 = (0);
var G__10686 = (0);
seq__10666 = G__10683;
chunk__10667 = G__10684;
count__10668 = G__10685;
i__10669 = G__10686;
continue;
}
} else {
...
});})(each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1))
);
});})(each_fixture_fn,G__10665,env,once_fixtures,each_fixtures,vec__10662,ns,vars__$1))
], null);
