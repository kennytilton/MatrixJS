...
return (function (p__10967){
var vec__10968 = p__10967;
var attr = cljs.core.nth.call(null,vec__10968,(0),null);
...
var args10971 = [];
var len__8226__auto___10974 = arguments.length;
var i__8227__auto___10975 = (0);
while(true){
if((i__8227__auto___10975 < len__8226__auto___10974)){
args10971.push((arguments[i__8227__auto___10975]));

var G__10976 = (i__8227__auto___10975 + (1));
i__8227__auto___10975 = G__10976;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args10971.length)].join('')));
...
var len__8226__auto___10979 = arguments.length;
var i__8227__auto___10980 = (0);
while(true){
if((i__8227__auto___10980 < len__8226__auto___10979)){
args__8233__auto__.push((arguments[i__8227__auto___10980]));

var G__10981 = (i__8227__auto___10980 + (1));
i__8227__auto___10980 = G__10981;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq10978){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10978));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__10982){
var map__10986 = p__10982;
...
var data = map__10986__$1;
var message = cljs.core.get.call(null,map__10986__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__10986__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10986__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__10988 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__10988,goog.events.EventType.CLICK,((function (G__10988,map__10986,map__10986__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__10988,map__10986,map__10986__$1,data,message,line,file))
);

return G__10988;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__10989){
var map__10993 = p__10989;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__10996){
var map__11000 = p__10996;
...
var messages = map__11000__$1;
var warnings = cljs.core.get.call(null,map__11000__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11000__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__11002 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__11002,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__11002,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__11003){
...
var messages = map__11006__$1;
var warnings = cljs.core.get.call(null,map__11006__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11006__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__11006,map__11006__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__11006,map__11006__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__11006,map__11006__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__11006,map__11006__$1,messages,warnings,exception))
;
