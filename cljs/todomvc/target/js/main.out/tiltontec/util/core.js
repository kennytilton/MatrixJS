...
var or__7113__auto__ = (function (){var and__7101__auto__ = a;
...
return cljs.core.PersistentHashSet.createAsIfByAssoc([x], true);
...
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([sought], true),coll);
}
});
...
tiltontec.util.core.rmap_setf = (function tiltontec$util$core$rmap_setf(p__16634,new_value){
var vec__16638 = p__16634;
var slot = cljs.core.nth.call(null,vec__16638,(0),null);
var ref = cljs.core.nth.call(null,vec__16638,(1),null);
...
tiltontec.util.core.rmap_meta_setf = (function tiltontec$util$core$rmap_meta_setf(p__16641,new_value){
var vec__16645 = p__16641;
var slot = cljs.core.nth.call(null,vec__16645,(0),null);
var ref = cljs.core.nth.call(null,vec__16645,(1),null);
...
tiltontec.util.core.err = (function (){var method_table__8046__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"tiltontec.util.core","err"),((function (method_table__8046__auto__,prefer_table__8047__auto__,method_cache__8048__auto__,cached_hierarchy__8049__auto__,hierarchy__8050__auto__){
return (function() { 
var G__16648__delegate = function (a1,args){
return cljs.core.fn_QMARK_.call(null,a1);
};
var G__16648 = function (a1,var_args){
var args = null;
...
while (G__16652__i < G__16652__a.length) {G__16652__a[G__16652__i] = arguments[G__16652__i + 1]; ++G__16652__i;}
  mas = new cljs.core.IndexedSeq(G__16652__a,0);
} 
return G__16651__delegate.call(this,fn,mas);};
G__16651.cljs$lang$maxFixedArity = 1;
G__16651.cljs$lang$applyTo = (function (arglist__16653){
var fn = cljs.core.first(arglist__16653);
var mas = cljs.core.rest(arglist__16653);
return G__16651__delegate(fn,mas);
});
...
var G__16654__delegate = function (bits){
...
while (G__16655__i < G__16655__a.length) {G__16655__a[G__16655__i] = arguments[G__16655__i + 0]; ++G__16655__i;}
  bits = new cljs.core.IndexedSeq(G__16655__a,0);
} 
return G__16654__delegate.call(this,bits);};
G__16654.cljs$lang$maxFixedArity = 0;
G__16654.cljs$lang$applyTo = (function (arglist__16656){
var bits = cljs.core.seq(arglist__16656);
return G__16654__delegate(bits);
});
...
}),(0),(10),cljs.core._conj.call(null,(function (){var x__7955__auto__ = n;
...
var result__8573__auto__ = cljs.core.first.call(null,cljs.core.deref.call(null,q));
...
var len__8226__auto___16658 = arguments.length;
var i__8227__auto___16659 = (0);
while(true){
if((i__8227__auto___16659 < len__8226__auto___16658)){
args__8233__auto__.push((arguments[i__8227__auto___16659]));

var G__16660 = (i__8227__auto___16659 + (1));
i__8227__auto___16659 = G__16660;
continue;
} else {
}
break;
...
return tiltontec.util.core.pln.cljs$core$IFn$_invoke$arity$variadic(argseq__8234__auto__);
});

tiltontec.util.core.pln.cljs$core$IFn$_invoke$arity$variadic = (function (r){
if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.first.call(null,r)], true),cljs.core.PersistentVector.EMPTY))){
...
tiltontec.util.core.pln.cljs$lang$applyTo = (function (seq16657){
return tiltontec.util.core.pln.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16657));
});
