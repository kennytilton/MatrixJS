...
return (function (p__8535){
var vec__8536 = p__8535;
var attr = cljs.core.nth.call(null,vec__8536,(0),null);
var v = cljs.core.nth.call(null,vec__8536,(1),null);
...
var args8539 = [];
var len__8226__auto___8542 = arguments.length;
var i__8227__auto___8543 = (0);
while(true){
if((i__8227__auto___8543 < len__8226__auto___8542)){
args8539.push((arguments[i__8227__auto___8543]));

var G__8544 = (i__8227__auto___8543 + (1));
i__8227__auto___8543 = G__8544;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args8539.length)].join('')));
...
var len__8226__auto___8547 = arguments.length;
var i__8227__auto___8548 = (0);
while(true){
if((i__8227__auto___8548 < len__8226__auto___8547)){
args__8233__auto__.push((arguments[i__8227__auto___8548]));

var G__8549 = (i__8227__auto___8548 + (1));
i__8227__auto___8548 = G__8549;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8546){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8546));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8550){
var map__8554 = p__8550;
...
var data = map__8554__$1;
var message = cljs.core.get.call(null,map__8554__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8554__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8554__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8556 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8556,goog.events.EventType.CLICK,((function (G__8556,map__8554,map__8554__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8556,map__8554,map__8554__$1,data,message,line,file))
);

return G__8556;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8557){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8564){
var map__8568 = p__8564;
...
var messages = map__8568__$1;
var warnings = cljs.core.get.call(null,map__8568__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8568__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8570 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8570,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8570,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8571){
...
var messages = map__8574__$1;
var warnings = cljs.core.get.call(null,map__8574__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8574__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8574,map__8574__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8574,map__8574__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8574,map__8574__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8574,map__8574__$1,messages,warnings,exception))
;
