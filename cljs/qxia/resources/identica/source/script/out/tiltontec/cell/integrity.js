...
var args10357 = [];
var len__7285__auto___10360 = arguments.length;
var i__7286__auto___10361 = (0);
while(true){
if((i__7286__auto___10361 < len__7285__auto___10360)){
args10357.push((arguments[i__7286__auto___10361]));

var G__10362 = (i__7286__auto___10361 + (1));
i__7286__auto___10361 = G__10362;
continue;
} else {
}
break;
...
tiltontec.cell.integrity.unfin_biz = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__6990__auto__ = (function tiltontec$cell$integrity$iter__10364(s__10365){
...
var c__6988__auto__ = cljs.core.chunk_first.call(null,s__10365__$2);
var size__6989__auto__ = cljs.core.count.call(null,c__6988__auto__);
var b__10367 = cljs.core.chunk_buffer.call(null,size__6989__auto__);
if((function (){var i__10366 = (0);
while(true){
if((i__10366 < size__6989__auto__)){
var i = cljs.core._nth.call(null,c__6988__auto__,i__10366);
cljs.core.chunk_append.call(null,b__10367,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,cljs.core.atom.call(null,cljs.core.PersistentVector.EMPTY)], null));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10367),tiltontec$cell$integrity$iter__10364.call(null,cljs.core.chunk_rest.call(null,s__10365__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10367),null);
}
} else {
var i = cljs.core.first.call(null,s__10365__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,cljs.core.atom.call(null,cljs.core.PersistentVector.EMPTY)], null),tiltontec$cell$integrity$iter__10364.call(null,cljs.core.rest.call(null,s__10365__$2)));
}
} else {
return null;
}
...
var args10369 = [];
var len__7285__auto___10375 = arguments.length;
var i__7286__auto___10376 = (0);
while(true){
if((i__7286__auto___10376 < len__7285__auto___10375)){
args10369.push((arguments[i__7286__auto___10376]));

var G__10377 = (i__7286__auto___10376 + (1));
i__7286__auto___10376 = G__10377;
continue;
} else {
}
break;
...
var vec__10372 = temp__4425__auto__;
var defer_info = cljs.core.nth.call(null,vec__10372,(0),null);
var task = cljs.core.nth.call(null,vec__10372,(1),null);
...
while(true){
var G__10385 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__10385) {
...
var temp__4423__auto___10391 = cljs.core.deref.call(null,tiltontec.cell.base._PLUS_client_q_handler_PLUS_);
if(cljs.core.truth_(temp__4423__auto___10391)){
var cqh_10392 = temp__4423__auto___10391;
cqh_10392.call(null,clientq);
} else {
tiltontec.cell.integrity.ufb_do.call(null,clientq,new cljs.core.Keyword(null,"client","client",-1323448117));
}

var G__10393 = (cljs.core.truth_(tiltontec.util.core.fifo_peek.call(null,tiltontec.cell.integrity.ufb_queue.call(null,new cljs.core.Keyword(null,"client","client",-1323448117))))?(function (){
...
var G__10394 = new cljs.core.Keyword(null,"deferred-state-change","deferred-state-change",-1362791478);
tag = G__10394;
continue;
...
if(cljs.core.truth_(temp__4425__auto__)){
var vec__10386 = temp__4425__auto__;
var defer_info = cljs.core.nth.call(null,vec__10386,(0),null);
var task_fn = cljs.core.nth.call(null,vec__10386,(1),null);
...
var G__10395 = new cljs.core.Keyword(null,"tell-dependents","tell-dependents",1916330388);
tag = G__10395;
continue;
} else {
return null;
...
var len__7285__auto___10404 = arguments.length;
var i__7286__auto___10405 = (0);
while(true){
if((i__7286__auto___10405 < len__7285__auto___10404)){
args__7292__auto__.push((arguments[i__7286__auto___10405]));

var G__10406 = (i__7286__auto___10405 + (1));
i__7286__auto___10405 = G__10406;
continue;
} else {
}
break;
...
tiltontec.cell.integrity.with_integrity.cljs$core$IFn$_invoke$arity$variadic = (function (_AMPERSAND_form,_AMPERSAND_env,p__10400,body){
var vec__10401 = p__10400;
var opcode = cljs.core.nth.call(null,vec__10401,(0),null);
var info = cljs.core.nth.call(null,vec__10401,(1),null);
...
tiltontec.cell.integrity.with_integrity.cljs$lang$applyTo = (function (seq10396){
...
return tiltontec.cell.integrity.with_integrity.cljs$core$IFn$_invoke$arity$variadic(G__10397,G__10398,G__10399,seq10396__$3);
});
...
var args__7292__auto__ = [];
var len__7285__auto___10410 = arguments.length;
var i__7286__auto___10411 = (0);
while(true){
if((i__7286__auto___10411 < len__7285__auto___10410)){
args__7292__auto__.push((arguments[i__7286__auto___10411]));

var G__10412 = (i__7286__auto___10411 + (1));
i__7286__auto___10411 = G__10412;
continue;
} else {
}
break;
...
tiltontec.cell.integrity.without_integrity.cljs$lang$applyTo = (function (seq10407){
...
return tiltontec.cell.integrity.without_integrity.cljs$core$IFn$_invoke$arity$variadic(G__10408,G__10409,seq10407__$2);
});
...
if(cljs.core.truth_(opcode)){
var result__8531__auto__ = new cljs.core.Keyword(null,"deferred-to-ufb-1","deferred-to-ufb-1",-1094275721);
...
var _STAR_within_integrity_STAR_10415 = tiltontec.cell.base._STAR_within_integrity_STAR_;
var _STAR_defer_changes_STAR_10416 = tiltontec.cell.base._STAR_defer_changes_STAR_;
...
var result__8531__auto__ = action.call(null,opcode,defer_info);
...
return result__8531__auto__;
}finally {tiltontec.cell.base._STAR_defer_changes_STAR_ = _STAR_defer_changes_STAR_10416;

tiltontec.cell.base._STAR_within_integrity_STAR_ = _STAR_within_integrity_STAR_10415;
}
}
}
}
