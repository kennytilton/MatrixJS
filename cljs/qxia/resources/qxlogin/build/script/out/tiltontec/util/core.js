...
tiltontec.util.core.rmap_setf = (function tiltontec$util$core$rmap_setf(p__13630,new_value){
var vec__13634 = p__13630;
var slot = cljs.core.nth.call(null,vec__13634,(0),null);
var ref = cljs.core.nth.call(null,vec__13634,(1),null);
...
tiltontec.util.core.rmap_meta_setf = (function tiltontec$util$core$rmap_meta_setf(p__13637,new_value){
var vec__13641 = p__13637;
var slot = cljs.core.nth.call(null,vec__13641,(0),null);
var ref = cljs.core.nth.call(null,vec__13641,(1),null);
...
return (function() { 
var G__13644__delegate = function (a1,args){
return cljs.core.fn_QMARK_.call(null,a1);
};
var G__13644 = function (a1,var_args){
var args = null;
...
while (G__13648__i < G__13648__a.length) {G__13648__a[G__13648__i] = arguments[G__13648__i + 1]; ++G__13648__i;}
  mas = new cljs.core.IndexedSeq(G__13648__a,0);
} 
return G__13647__delegate.call(this,fn,mas);};
G__13647.cljs$lang$maxFixedArity = 1;
G__13647.cljs$lang$applyTo = (function (arglist__13649){
var fn = cljs.core.first(arglist__13649);
var mas = cljs.core.rest(arglist__13649);
return G__13647__delegate(fn,mas);
});
...
var G__13650__delegate = function (bits){
...
while (G__13651__i < G__13651__a.length) {G__13651__a[G__13651__i] = arguments[G__13651__i + 0]; ++G__13651__i;}
  bits = new cljs.core.IndexedSeq(G__13651__a,0);
} 
return G__13650__delegate.call(this,bits);};
G__13650.cljs$lang$maxFixedArity = 0;
G__13650.cljs$lang$applyTo = (function (arglist__13652){
var bits = cljs.core.seq(arglist__13652);
return G__13650__delegate(bits);
});
...
var result__13337__auto__ = cljs.core.first.call(null,cljs.core.deref.call(null,q));
...
var len__7285__auto___13654 = arguments.length;
var i__7286__auto___13655 = (0);
while(true){
if((i__7286__auto___13655 < len__7285__auto___13654)){
args__7292__auto__.push((arguments[i__7286__auto___13655]));

var G__13656 = (i__7286__auto___13655 + (1));
i__7286__auto___13655 = G__13656;
continue;
} else {
}
break;
...
tiltontec.util.core.pln.cljs$lang$applyTo = (function (seq13653){
return tiltontec.util.core.pln.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13653));
});
