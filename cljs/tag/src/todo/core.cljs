(ns todo.core
  (:require [cljs.pprint :as pp]
            ...
            [todo.todo :refer [gTodo gItems-raw gTodo-lookup TODO_LS_PREFIX make-todo
            			...
            			clear-completed todo-delete-by-key
...
(defn mk-dashboard []
	(footer (:class "footer"
		...
		(button (:class "clear-completed"
				 ...
				 :onclick (on-evt 'clear_completed))
			"Clear completed")))
